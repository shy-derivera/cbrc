	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content">
	            ...
	            $query=mysqli_query($conn,"select * from `es_announcement` where id ='$id'");
	            $row=mysqli_fetch_array($query);
            ?>
										<form method="POST" action="process_update_announcement.php?id=<?php echo $id; ?>" enctype="multipart/form-data" class="row g-3">
											<div class="col-sm-6">
												...
												<div class="col-sm-12">
													...
													<input type="text" name="description" value="<?php echo $row['body']; ?>" id="" style="height:50px;" class="form-control"></textarea>
											</div>
											...
											<div class="col-sm-6">
								             ...
								             <option value="<?php echo $row['view_group']; ?>"><?php echo $row['view_group']; ?></option>
