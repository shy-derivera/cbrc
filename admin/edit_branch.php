	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content">
	            ...
	            $query=mysqli_query($conn,"select * from `es_branch` where branch_id ='$branch_id'");
	            $row=mysqli_fetch_array($query);
            ?>
										<form method="POST" action="process_update_branch.php?branch_id=<?php echo $branch_id; ?>" enctype="multipart/form-data" class="row g-3">
											<div class="col-sm-6">
												<label for="" class="4orm-label">Branch Name</label>
												<input type="text" name="branch" value="<?php echo $row['branch']; ?>" class="form-control" placeholder="Branch" required>
											</div>
											<div class="col-sm-6">
