	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content">
	            ...
	            $lec_id=$_GET['lec_id'];
	            $query=mysqli_query($conn,"select * from `es_salary` where lecturer_id ='$lec_id'");
	            $row=mysqli_fetch_array($query);
            ?>
										<form method="POST" action="process_update_salary.php?lec_id=<?php echo $lec_id; ?>" enctype="multipart/form-data" class="row g-3">
											...
											<div class="col-sm-4">
											 ...
											 <input type="number" name="hours" value="<?php echo $row['hours']; ?>"  class="form-control" >
									        </div>
