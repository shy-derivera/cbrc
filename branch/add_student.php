		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ms-auto">
						<div class="btn-group">
							<a href="view_students_enrolled.php" class="btn btn-primary px-5 radius-30" style="margin-right:10px;">< BACK</a>							
						</div>
					</div>
				</div>
				<!--end breadcrumb-->
				...
				<div class="form-body">
					<form method="POST" action="process_enroll_student.php" enctype="multipart/form-data" class="row g-3">
						<div class="col-sm-2">
							...
							<input type="text" name="student_number" value="<?php echo str_pad($series, 6, '0', STR_PAD_LEFT); ?>" class="form-control" placeholder="Student #" required readonly>
						</div>
