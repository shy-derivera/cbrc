	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				$query=mysqli_query($conn,"SELECT * FROM `es_students` WHERE status='VERIFIED' AND school_branch='$branch'");
          ...
          echo $rowcount;
				...
				$query=mysqli_query($conn,"SELECT * FROM `es_students` WHERE status='DROPPED' AND school_branch='$branch'");
          $rowcount=mysqli_num_rows($query);
          echo $rowcount;
					?>
										</h4>
				...
				$query=mysqli_query($conn,"SELECT * FROM `es_lecturers` WHERE status='ACTIVE' AND branch = '$branch'");
          $rowcount=mysqli_num_rows($query);
          echo $rowcount;
					?>
										</h4>
				...
				$query=mysqli_query($conn,"SELECT * FROM `es_users` WHERE user_status='ACTIVE' AND user_branch='$branch'");
          $rowcount=mysqli_num_rows($query);
          echo $rowcount;
					?>
										</h4>
				...
				$query=mysqli_query($conn,"SELECT * FROM `es_students` WHERE status = 'VERIFIED' AND school_branch='$branch' ORDER BY id DESC LIMIT 10");
